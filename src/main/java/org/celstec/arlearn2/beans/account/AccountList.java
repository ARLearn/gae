...
public class AccountList extends Bean {
    ...
    public static BeanSerializer serializer = new BeanSerializer() {
        ...
        public JSONObject toJSON(Object bean) {
            ...
            try {
                ...
                if (accountList.getResumptionToken() != null)
                    returnObject.put("resumptionToken", accountList.getResumptionToken());
                if (accountList.getFrom() != null)
                    returnObject.put("from", accountList.getFrom());
    ...
    public static BeanDeserializer deserializer = new BeanDeserializer() {
        ...
        public void initBean(JSONObject object, Bean genericBean) throws JSONException {
            ...
            if (object.has("from"))
                accountList.setFrom(object.getLong("from"));
