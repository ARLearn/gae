...
//				Method m = beanCls.getDeclaredMethod(getBeanMethodName(field.getName()), field.getType());
	...
	static {
		...
		customDeserializerMapString.put("org.celstec.arlearn2.beans.game.GameThemesList", GameThemesList.deserializer);
		...
		customDeserializerMapString.put("org.celstec.arlearn2.beans.store.GameOrganisation", GameOrganisation.deserializer);
