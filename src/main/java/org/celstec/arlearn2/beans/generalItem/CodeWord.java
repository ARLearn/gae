...
public class CodeWord  extends GeneralItem {
    ...
    public static GeneralItemSerializer serializer = new GeneralItemSerializer() {
        ...
        public JSONObject toJSON(Object bean) {
            ...
            try {
                ...
                if (mct.getCombinationLength() != null)
                    returnObject.put("combinationLength", mct.getCombinationLength());
    ...
    public static GeneralItemDeserializer deserializer = new GeneralItemDeserializer() {
        ...
        @Override
        public CodeWord toBean(JSONObject object) {
            CodeWord mct = new CodeWord();
            try {
                initBean(object, mct);
            } catch (JSONException e) {
                e.printStackTrace();
        ...
        public void initBean(JSONObject object, Bean genericBean) throws JSONException {
            ...
            CodeWord mctItem = (CodeWord) genericBean;
